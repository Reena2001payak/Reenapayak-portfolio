...
function openGmail() {
  const email = "Reenapayak400@gmail.com";
...
function downloadCV() {
  ...
  link.href = "images/Reena Payak Resume.pdf"; // Path to your resume file
  link.download = "Reena payak Resume"; // Name for the downloaded file
